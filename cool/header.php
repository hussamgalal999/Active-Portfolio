...
<head>
    <meta charset="utf-8">
    <title>QudDesign - Personal Template</title>
    ...
    <link rel="shortcut icon" href="images/brand/qud.png">
    <link href="plugins/filter/magnific-popup.css" rel="stylesheet" type="text/css">
    <link href="plugins/animated/headline.css" rel="stylesheet" type="text/css"><!-- App css -->
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-navbar">
        <div class="container"><a class="navbar-brand" href="#"><img src="images/brand/qud.png" alt="" class="rounded-circle thumb-md mb-2">
            <i class=" "></i>
            QudDesign</a>
                        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#nav" aria-controls="nav" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button><!--end navbar-toggler-->
                        <div class="collapse navbar-collapse" id="nav">
                            <ul class="navbar-nav ml-auto">
                                <li class="nav-item"><a class="btn btn-blue btn-sm px-4" href="#" id="lnkPrint"><i class="'uil uil-print mr-1 font-16"></i>Print</a></li>
                            </ul>
                        </div><!--end collapse-->
                    </div><!--end container-->
    </nav><!--end nav-->
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-print-6 align-self-center mb-3 mb-lg-0">
                            <div class="zoo-profile-main">
                                ...
                                <div class="zoo-profile_user-detail">
                                    <h5 class="zoo-user-name">Hossam Galal</h5>
                                    <p class="cd-headline loading-bar"><span class="cd-words-wrapper"><b
                                                class="is-visible">Web Designer</b><b>Freelancer</b> <b>Software Developer</b> <b>Blogger</b>
                                                <b>Youtuber</b></span></p>
                        ...
                        <div class="col-sm-4 col-print-4 ml-auto">
                            <ul class="list-unstyled personal-detail">
                                <li><i class="'uil uil-phone-volume mr-2"></i> <b>Phone </b>:  <br>   (+20)011-518-580-57 </li>
                                <li class="mt-2"><i class="uil uil-envelope mt-2 mr-2"></i> <b>Email </b>:
                                   hussamgalal999@gmail.com</li>


 
                                    <li><i class="'uil uil-phone-volume mr-2"></i> <b>Contact Me </b>:
                                        <a href="https://wa.me/+2001151858057"><br> WhatsApp Click here</a>

                                    </li>
                            </ul><!--end personal-detail-->
                            
                            <ul class="list-inline social-icon mb-0">
                                <li class="list-inline-item"><a href="https://whatsapp.com/hussamgalal999" class="bg-secondary"><i class="uil uil-whatsapp"></i></a></li>
                                <li class="list-inline-item"><a href="https://www.facebook.com/hossgalal99" class="bg-blue"><i
                                            class="uil uil-facebook-f"></i></a></li>
                                <li class="list-inline-item"><a href="https://twitter.com/hussamgalal999" class="bg-secondary"><i
                                            class="uil uil-twitter"></i></a></li>
                                            <li class="list-inline-item"><a href="https://github.com/hussamgalal999" class="bg-secondary"><i class="uil uil-github"></i></a></li>
                                                        ...
                                                        <li class="list-inline-item"><a href="" class="bg-pink"><i
                                                            class="uil uil-smile"></i></a></li>  
                                                            
                                                            

                                                            <li class="list-inline-item"><a href="" class="bg-pink"><i
                                                                class="uil uil-comment-dots"></i></a></li> 
                                                                
                                                                <li class="list-inline-item"><a href="" class="bg-pink"><i
                                                                    class="uil uil-trophy"></i></a></li> 
                                                                    <li class="list-inline-item"><a href="" class="bg-pink"><i
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-6 col-print-6">
                        <h4 class="text-primary font-weight-bold">I'm Hossam Galal</h4>
                    ...
                    <div class="col-sm-5 col-print-5 offset-lg-1 align-self-center">
                        <p><span class="personal-detail-title">Name</span> <span class="personal-detail-info">Hossam
                                Galal</span></p>
                        <p><span class="personal-detail-title">Date of birth</span> <span
                                class="personal-detail-info">01 Dec 1999</span></p>
                        <p><span class="personal-detail-title">Spoken Langages</span> <span
                                class="personal-detail-info">Arabic - English - French - German</span></p>
                        <p><span class="personal-detail-title">Nationality</span> <span
                                class="personal-detail-info">Egyptian </span></p>
                        <p><span class="personal-detail-title">Interest</span> <span class="personal-detail-info">learn, Music,
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-print-6">
                                ...
                                <div class="timeline">
                                    <div class="time-item">
                                        <div class="item-info">
                                            <div class="font-14">2019 - 2015</div>
                                    ...
                                    <div class="time-item mt-3">
                                        <div class="item-info">
                                            <div class="font-14">2019 - 2025</div>
                                            <h5 class="my-1 text-dark">EST-MINYA Institute</h5>
                                            <p>Bachelor of Management Information System</p>
                                        </div>
                                    </div><!--end time-item-->
                                    <div class="time-item mt-3">
                                        <div class="item-info">
                                            <div class="font-14">2021 - 2022</div>
                                            <h5 class="my-1 text-dark">Mirco Master</h5>
                                            <p> Mirco Master of Computer Science</p>
                                        </div>
                                    </div><!--end time-item-->
                                </div><!--end timeline-->
                            </div><!--end col-->
                            <div class="col-sm-6 col-print-6">
                                ...
                                <div class="timeline">
                                    <div class="time-item">
                                        <div class="item-info">
                                            <div class="font-14">2019 - 2021</div>
                                            <h5 class="my-1 text-dark">Ui/Ux Designer</h5>
                                            <p>Designer Qudsystem.Ltd</p>
                                        </div>
                                    </div><!--end time-item-->
                                    <div class="time-item mt-3">
                                        <div class="item-info">
                                            <div class="font-14">2022 - 2023</div>
                                            <h5 class="my-1 text-dark">Junior Developer</h5>
                                            <p>QudSystem.Ltd</p>
                                        </div>
                                    </div><!--end time-item-->
                                    <div class="time-item mt-3">
                                        <div class="item-info">
                                            <div class="font-14">2023 - 2024</div>
                                    ...
                                    <div class="carousel-item">
                                        <div class="text-center">
                                            <p class="px-4">There are many variations of passages of Lorem Ipsum
                                                available, but the majority have suffered alteration in passages of some
                                                form, by injected humour.</p>
                                            <div><img src="images/users/cary.png" alt=""
                                                    class="rounded-circle thumb-md mb-2">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="row container-grid nf-col-3 projects-wrapper">
                                    ...
                                    <div class="col-md-4 col-6 p-0 nf-item design frontend">
                                        <div class="item-box"><a class="cbox-gallary1 mfp-image"
                                                href="images/portfolio/3.jpg" title="Facebook"><img
                                                    class="item-container" src="images/portfolio/3.jpg" alt="3">
                                                <div class="item-mask">
                                                    <div class="item-caption">
                                    ...
                                    <div class="col-md-4 col-6 p-0 nf-item design frontend">
                                        <div class="item-box"><a class="cbox-gallary1 mfp-image"
                                                href="images/portfolio/4.jpg" title="WhatsApp"><img
                                                    class="item-container" src="images/portfolio/4.jpg" alt="4">
                                                <div class="item-mask">
                                                    <div class="item-caption">
...
<!-- ==============================      =================================== -->
                                    ...
                                    <div class="col-md-4 col-6 p-0 nf-item design frontend">
                                        <div class="item-box"><a class="cbox-gallary1 mfp-image"
                                                href="images/portfolio/6.jpg" title="WhatsApp"><img
                                                    class="item-container" src="images/portfolio/6.jpg" alt="6">
                                                <div class="item-mask">
                                                    <div class="item-caption">
                                                        <h5 class="text-light">WhatsApp</h5>
                                                        <p class="text-light">Graphic Design</p>
                                    ...
                                    <div class="col-md-4 col-6 p-0 nf-item design frontend">
                                        <div class="item-box"><a class="cbox-gallary1 mfp-image"
                                                href="images/portfolio/7.jpg" title="WhatsApp"><img
                                                    class="item-container" src="images/portfolio/7.jpg" alt="7">
                                                <div class="item-mask">
                                                    <div class="item-caption">
                                                        <h5 class="text-light">WhatsApp</h5>
                                                        <p class="text-light">Graphic Design</p>
                                    ...
                                    <div class="col-md-4 col-6 p-0 nf-item design frontend">
                                        <div class="item-box"><a class="cbox-gallary1 mfp-image"
                                                href="images/portfolio/8.jpg" title="WhatsApp"><img
                                                    class="item-container" src="images/portfolio/8.jpg" alt="8">
                                                <div class="item-mask">
                                                    <div class="item-caption">
                                                        <h5 class="text-light">WhatsApp</h5>
                                                        <p class="text-light">Graphic Design</p>
                                    ...
                                    <div class="col-md-4 col-6 p-0 nf-item design frontend">
                                        <div class="item-box"><a class="cbox-gallary1 mfp-image"
                                                href="images/portfolio/9.jpg" title="WhatsApp"><img
                                                    class="item-container" src="images/portfolio/9.jpg" alt="9">
                                                <div class="item-mask">
                                                    <div class="item-caption">
                                                        <h5 class="text-light">WhatsApp</h5>
                                                        <p class="text-light">Graphic Design</p>
                                    ...
                                    <div class="col-md-4 col-6 p-0 nf-item design frontend">
                                        <div class="item-box"><a class="cbox-gallary1 mfp-image"
                                                href="images/portfolio/10.jpg" title="WhatsApp"><img
                                                    class="item-container" src="images/portfolio/10.jpg" alt="10">
                                                <div class="item-mask">
                                                    <div class="item-caption">
                                                        <h5 class="text-light">WhatsApp</h5>
                                                        <p class="text-light">Graphic Design</p>
                                    ...
                                    <div class="col-md-4 col-6 p-0 nf-item design frontend">
                                        <div class="item-box"><a class="cbox-gallary1 mfp-image"
                                                href="images/portfolio/11.jpg" title="WhatsApp"><img
                                                    class="item-container" src="images/portfolio/11.jpg" alt="11">
                                                <div class="item-mask">
                                                    <div class="item-caption">
                                                        <h5 class="text-light">WhatsApp</h5>
                                                        <p class="text-light">Graphic Design</p>
                                    ...
                                    <div class="col-md-4 col-6 p-0 nf-item design frontend">
                                        <div class="item-box"><a class="cbox-gallary1 mfp-image"
                                                href="images/portfolio/12.jpg" title="WhatsApp"><img
                                                    class="item-container" src="images/portfolio/12.jpg" alt="12">
                                                <div class="item-mask">
                                                    <div class="item-caption">
                                                        <h5 class="text-light">WhatsApp</h5>
                                                        <p class="text-light">Graphic Design</p>
                                    ...
                                    <div class="col-md-4 col-6 p-0 nf-item design frontend">
                                        <div class="item-box"><a class="cbox-gallary1 mfp-image"
                                                href="images/portfolio/13.jpg" title="WhatsApp"><img
                                                    class="item-container" src="images/portfolio/13.jpg" alt="13">
                                                <div class="item-mask">
                                                    <div class="item-caption">
                                                        <h5 class="text-light">WhatsApp</h5>
                                                        <p class="text-light">Graphic Design</p>
                                    ...
                                    <div class="col-md-4 col-6 p-0 nf-item design frontend">
                                        <div class="item-box"><a class="cbox-gallary1 mfp-image"
                                                href="images/portfolio/15.jpg" title="WhatsApp"><img
                                                    class="item-container" src="images/portfolio/14.jpg" alt="15">
                                                <div class="item-mask">
                                                    <div class="item-caption">
                                                        <h5 class="text-light">WhatsApp</h5>
                                                        <p class="text-light">Graphic Design</p>
                                    ...
                                    <div class="col-md-4 col-6 p-0 nf-item design">
                                        <div class="item-box"><a class="cbox-gallary1 mfp-image"
                                                href="images/portfolio/15.jpg" title="Nokia"><img class="item-container"
                                                    src="images/portfolio/15.jpg" alt="1">
                                                <div class="item-mask">
                                                    <div class="item-caption">
                                    ...
                                    <div class="col-md-4 col-6 p-0 nf-item backend frontend">
                                        <div class="item-box"><a class="cbox-gallary1 mfp-image"
                                                href="images/portfolio/16.jpg" title="Oppo"><img class="item-container"
                                                    src="images/portfolio/16.jpg" alt="16">
                                                <div class="item-mask">
                                                    <div class="item-caption">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="contact-info">
                            ...
                            <div class="content">
                                <h5>Free Call To Me:</h5><span>(+20) 011-518-580-57</span>
                            </div>
                        </div><!--end contact-info-->
                        <div class="contact-info">
                            <div class="icon"><i class="uil uil-envelope"></i></div>
                            <div class="content">
                                <h5>Mail Me:</h5><span>hussamgalal999@gmail.com</span>
                            </div>
                        </div><!--end contact-info-->
                        <div class="contact-info">
                            <div class="icon"><i class="uil uil-map-marker"></i></div>
                            <div class="content">
                                <h5>Find Me:</h5><span>Cairo City, Egypt</span>
                            </div>
                        </div><!--end contact-info-->
                    </div><!--end col-->
                    <div class="col-sm-8">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <p class="copyright mb-0 py-4">© 2024. Design By QudDesign</p>
                    </div><!--end col-->
                </div><!--end row-->
            </div><!--end container-->
